...
default_config = SimpleNamespace(
    ...
    lips_aug_rotate_ratio=0.17,
    lips_aug_rotate_degrees=5,
    lips_aug_expand_ratio=0.15,
    lips_aug_expand_pct=0.05,
    face_aug_rotate_ratio=0.20,
    face_aug_rotate_degrees=4,
    eyes_aug_shift_ratio=0.15,
    eyes_aug_shift=0.025,
    eyes_aug_expand_ratio=0.18,
